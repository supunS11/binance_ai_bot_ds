...
FIELDNAMES = [
    ...
    "depth_consistency_pct", "depth_trend_aligned", "whale_notional", "whale_direction", "whale_aligned",
...
def append_signal(signal, plan, execution_result=None):
    ...
    row.update({
        ...
        # config.ENTRY_RANGE_POSITION_REJECT_ENABLED - where in the recent
        # range this entry sat, 0.0 = ideal end for the side, 1.0 = worst.
        # Written whether or not that gate is on.
        ...
        "depth_consistency_pct": signal.get("depth_consistency_pct"),
        "depth_trend_aligned": signal.get("depth_trend_aligned"),
        "whale_notional": signal.get("whale_notional"),
        "whale_direction": signal.get("whale_direction"),
        "whale_aligned": signal.get("whale_aligned"),
